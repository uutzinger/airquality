...
| p: print current settings             | s: save settings (JSON & binary)      |
| d: create default seetings            | r: read settings (JSON)               |
|                                       | L: list content of filesystem         |
==Network===============================|==MQTT==================================
| P1: SSID 1, P1myssid                  | u: mqtt username, umqtt or empty      |
| P2: SSID 2, P2myssid                  | w: mqtt password, ww1ldc8ts or empty  |
| P3: SSID 3, P3myssid                  | q: send mqtt immediatly, q            |
