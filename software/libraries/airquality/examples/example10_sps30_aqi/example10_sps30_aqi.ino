 ...
 *     Fixed compiler warning with IDE 1.8.12
...
void setup()
{
  ...
  serialTrigger((char*) "SPS30-Example10: Read values, store and calculate AQI. ESP32 or ESP8266 ONLY !  Press <enter> to start");
