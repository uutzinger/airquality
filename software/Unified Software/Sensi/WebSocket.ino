...
void webSocketEvent(uint8_t num, WStype_t type, uint8_t * payload, size_t lenght) {
  ...
  switch (type) {
    case WStype_DISCONNECTED:
      if (mySettings.debuglevel  == 3) { sprintf(tmpStr, "Websocket [%u] disconnected!\r\n", num); printSerialTelnet(tmpStr); }
    ...
    case WStype_CONNECTED:
      {
        ...
        if (mySettings.debuglevel  == 3) { sprintf(tmpStr, "Websocket [%u] connection from %u.%u.%u.%u url: %s\r\n", num, ip[0], ip[1], ip[2], ip[3], payload); printSerialTelnet(tmpStr); }
        ws_connected = true;
        //ForceSendValues = 1;
      ...
      break;
    case WStype_TEXT:
      if (mySettings.debuglevel  == 3) { sprintf(tmpStr, "Websocket [%u] got text data: %s\r\n", num, payload); printSerialTelnet(tmpStr); }
      break;
    case WStype_BIN:
      if (mySettings.debuglevel  == 3) { 
        sprintf(tmpStr, "Websocket [%u] got binary data length: %u\r\n", num, lenght); printSerialTelnet(tmpStr);
...
void updateWebSocketMessage() {
    ...
    if (bme280NewDataWS) {
      ...
      if (mySettings.debuglevel == 3) { sprintf(tmpStr, "BME280 WebSocket data boradcasted, len: %u\r\n", strlen(payLoad)); printSerialTelnet(tmpStr); }      
    }
    ...
    if (scd30NewDataWS)  {
      ...
      if (mySettings.debuglevel == 3) { sprintf(tmpStr, "SCD30 WebSocket data boradcasted, len: %u\r\n", strlen(payLoad)); printSerialTelnet(tmpStr); }
    }
    ...
    if (sgp30NewDataWS)  {
      ...
      if (mySettings.debuglevel == 3) { sprintf(tmpStr, "SGP30 WebSocket data boradcasted, len: %u\r\n", strlen(payLoad)); printSerialTelnet(tmpStr); }
    }
    ...
    if (sps30NewDataWS)  {
      ...
      if (mySettings.debuglevel == 3) { sprintf(tmpStr, "SPS30 WebSocket data boradcasted, len: %u\r\n", strlen(payLoad)); printSerialTelnet(tmpStr); }      
    }
    ...
    if (ccs811NewDataWS) {
      ...
      if (mySettings.debuglevel == 3) { sprintf(tmpStr, "CCS811 WebSocket data boradcasted, len: %u\r\n", strlen(payLoad)); printSerialTelnet(tmpStr); }      
    }
    ...
    if (bme680NewDataWS) {
      ...
      if (mySettings.debuglevel == 3) { sprintf(tmpStr, "BME680 WebSocket data boradcasted, len: %u\r\n", strlen(payLoad)); printSerialTelnet(tmpStr); }      
    }
    ...
    if (mlxNewDataWS) {
      ...
      webSocket.broadcastTXT(payLoad);      
      mlxNewDataWS = false;
      if (mySettings.debuglevel == 3) { sprintf(tmpStr, "MLX WebSocket data boradcasted, len: %u\r\n", strlen(payLoad)); printSerialTelnet(tmpStr); }      
    }  
    ...
    if (timeNewDataWS) {
      ...
      webSocket.broadcastTXT(payLoad);      
      timeNewDataWS = false;
      if (mySettings.debuglevel == 3) { sprintf(tmpStr, "Time WebSocket data boradcasted, len: %u\r\n", strlen(payLoad)); printSerialTelnet(tmpStr); }      
    }
    ...
    if (dateNewDataWS) {
      ...
      webSocket.broadcastTXT(payLoad);      
      dateNewDataWS = false;
      if (mySettings.debuglevel == 3) { sprintf(tmpStr, "Date WebSocket data boradcasted, len: %u\r\n", strlen(payLoad)); printSerialTelnet(tmpStr); }      
    }
}
